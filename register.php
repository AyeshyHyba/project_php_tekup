                        ...
                        <form method="post" action="" onsubmit="" >
                            <div class="box_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pr" placeholder="Your last name">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="pwd1" name="pwd1" placeholder="Your password">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group text-center add_top_30">
                                    <input class="btn_1"  name="register" type="submit" value="Submit" onclick=""window.location.href = "login.html"">
                                </div>
                            </div>
                        </form>
                    </div>
